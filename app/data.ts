...
export const youtuberPicks = [
  ...
  {
    id: 'yoshida-akari-march-2026',
    videoId: 'ko2UjqkDAH8',
    youtuberName: '吉田朱里',
    channel: '登録者数 約98.1万人',
    publishedAt: '2026-04-01',
    videoTitle: '【3月のお気に入り16選】今月感動コスメ多すぎ!!!使い倒し確定の下地・推し変したファンデ・時短スキンケアなど🤍',
    products: [
      {
        name: 'ディオール ディオールスキン フォーエヴァー フルイド スキン グロウ',
        price: '¥7,700',
        comment: '【今月の主役・本気推し】長年愛用のファンデから「乗り換えキャンペーン」したくなるほど感動したリニューアル品。美容液感覚で手で塗ってもムラにならず、薄膜なのにカバー力とツヤが過去最高レベルです。',
        amazonKeyword: 'ディオール ディオールスキン フォーエヴァー フルイド スキン グロウ',
        rakutenKeyword: 'ディオール フォーエヴァー フルイド スキン グロウ',
      },
      {
        name: 'ファンケル マイルドクレンジング オイル',
        price: '¥1,870',
        comment: '【リピ確定・摩擦ゼロ】「この値段でこのクオリティは事件」と驚くほどの進化。肌の上をフィギュアスケートのように滑るトロトロ質感で、ウォータープルーフのメイクもするんと落とせます。',
        amazonKeyword: 'ファンケル マイルドクレンジング オイル',
        rakutenKeyword: 'ファンケル マイルドクレンジング オイル リニューアル',
      },
      {
        name: 'エリクシール デーケアレボリューション トーンアップ BE',
        price: '¥3,410',
        comment: '【時短の神・最新色】ドラッグストアで買える名品の新色ベージュ。ファンデなしでもこれ一本で肌が整い、シミの原因も抑制してくれる高機能下地。最近はこれとコンシーラーだけで済ませるほど信頼しています。',
        amazonKeyword: 'エリクシール デーケアレボリューション トーンアップ BE',
        rakutenKeyword: 'エリクシール デーケアレボリューション トーンアップ BE',
      },
      {
        name: 'KANEBO スキン コンダクター モイスチャライジング クリーム',
        price: '¥6,000',
        comment: '【メイクの接着剤】朝のスキンケアの最後に使うと、肌をメイクに最適な「するん」とした状態に整えてくれます。ベタつかないのに水分をしっかり蓄え皮脂コントロールもしてくれるため、メイク持ちが劇的に変わります。',
        amazonKeyword: 'KANEBO スキン コンダクター モイスチャライジング クリーム',
        rakutenKeyword: 'カネボウ スキン コンダクター モイスチャライジング クリーム',
      },
      {
        name: 'ドクターK ABCケアプレミアムセラム TA',
        price: '¥16,500',
        comment: '【投資価値ありの逸品】毛穴とハリに特化したプレミアム美容液。使い切る頃には肌のキメが整いコンディションが格段に上がりました。「スキンケアのどこにお金をかけるべきか」と聞かれたら真っ先に勧める一本です。',
        amazonKeyword: 'ドクターK ABCケアプレミアムセラム TA',
        rakutenKeyword: 'ドクターK ABC-G リップセラム TA',
      },
    ],
  },
  {
    id: 'kayoko-yazaki-spring-2026',
    videoId: 'oCtnRt0tPws',
    youtuberName: 'かよこやざき',
    channel: '登録者数 約12.3万人',
    publishedAt: '2026-03-30',
    videoTitle: '【2026春新作】パーソナルカラー真逆でも盛れた神コスメまとめ🌸',
    products: [
      {
        rank: 1,
        name: 'イヴ・サンローラン ラブヌード リップスティック 08 モーブヘイズ',
        price: '¥5,940',
        comment: '【今回の一番のお気に入り】唇の縦じわをぼかしながら、ふっくらとボリュームのある「今っぽい唇」を演出。08番のモーブブラウンは村になりにくく大人っぽく仕上がる、全10色の中でも特に推しのカラーです。',
        amazonLink: 'https://www.amazon.co.jp/s?k=イヴサンローラン+ラブヌード+リップスティック+08&tag=lueur0f-22',
        rakutenLink: 'https://hb.afl.rakuten.co.jp/ichiba/521658b7.a1689a38.521658b8.7fbb4952/?pc=https%3A%2F%2Fsearch.rakuten.co.jp%2Fsearch%2Fmall%2Fイヴ・サンローランラブヌードリップスティック08モーブヘイズ%2F',
        rakutenKeyword: 'イヴ・サンローラン ラブヌード リップスティック 08 モーブヘイズ',
      },
      {
        rank: 2,
        name: 'トム フォード ビューティ アイ カラー クォード 38 メタリック モーブ',
        price: '¥12,980',
        comment: '【進化を遂げた神粉質】リニューアルされたアイシャドウで偏光ラメの輝きがゴージャス。パーソナルカラー的に苦手なプラム系でも、上品さと個性が絶妙にマッチし大人華やかな目元を叶えてくれました。',
        amazonLink: 'https://www.amazon.co.jp/s?k=トムフォード+アイカラークォード+38+メタリックモーブ&tag=lueur0f-22',
        rakutenLink: 'https://hb.afl.rakuten.co.jp/ichiba/521658b7.a1689a38.521658b8.7fbb4952/?pc=https%3A%2F%2Fsearch.rakuten.co.jp%2Fsearch%2Fmall%2Fトムフォードアイカラークォードメタリックモーブ38%2F',
        rakutenKeyword: 'トム フォード アイ カラー クォード 38 メタリック モーブ',
      },
      {
        rank: 3,
        name: 'エテュセ トーンアップ アイチューナー 01 / 02',
        price: '¥1,650',
        comment: '【プチプラで一番感動】上まぶた用(01)と涙袋用(02)のベースセット。02のベビーベージュは白浮きせず自然な凹凸感とツヤを演出。アイシャドウの発色と色持ちが劇的に良くなる感動の土台アイテムです。',
        amazonLink: 'https://www.amazon.co.jp/s?k=エテュセ+トーンアップ+アイチューナー&tag=lueur0f-22',
        rakutenLink: 'https://hb.afl.rakuten.co.jp/ichiba/521658b7.a1689a38.521658b8.7fbb4952/?pc=https%3A%2F%2Fsearch.rakuten.co.jp%2Fsearch%2Fmall%2Fエテュセトーンアップアイチューナーベース%2F',
        rakutenKeyword: 'エテュセ トーンアップ アイチューナー 01 02',
      },
      {
        rank: 4,
        name: 'ポール & ジョー プロテクティング ヴェール コンパクト 01',
        price: '¥6,050',
        comment: '【高カバー×美容液効果】美容液・下地・ファンデのオールインワン。薄膜ながら赤みや毛穴をしっかりカバーし、ベタつかず肌にピタッとフィット。混合肌・オイリー肌でも崩れにくいクッションファンデです。',
        amazonLink: 'https://www.amazon.co.jp/s?k=ポール&ジョー+プロテクティング+ヴェール+コンパクト+01&tag=lueur0f-22',
        rakutenLink: 'https://hb.afl.rakuten.co.jp/ichiba/521658b7.a1689a38.521658b8.7fbb4952/?pc=https%3A%2F%2Fsearch.rakuten.co.jp%2Fsearch%2Fmall%2Fポール%26ジョープロテクティングヴェールコンパクト01%2F',
        rakutenKeyword: 'ポール & ジョー プロテクティング ヴェール コンパクト 01',
      },
      {
        rank: 5,
        name: 'THREE グラムトーン カラーカスタード 09',
        price: '¥3,300',
        comment: '【万能マルチカラー】チーク・アイ・リップ・眉にも使える春の新色。09番は淡い発色でやりすぎ感が出ず扱いやすい。メイク全体が濃くなりすぎた時のバランス調整にも最適な、さりげない血色感を与えてくれます。',
        amazonLink: 'https://www.amazon.co.jp/s?k=THREE+グラムトーン+カラーカスタード+09&tag=lueur0f-22',
        rakutenLink: 'https://hb.afl.rakuten.co.jp/ichiba/521658b7.a1689a38.521658b8.7fbb4952/?pc=https%3A%2F%2Fsearch.rakuten.co.jp%2Fsearch%2Fmall%2FTHREEグラムトーンカラーカスタード09%2F',
        rakutenKeyword: 'THREE グラムトーン カラーカスタード 09',
      },
    ],
  },
  {
  ...
  {
    id: 'hiro-beauty-2024-04',
    videoId: 'VcXYgVSSJQ4',
    youtuberName: '小田切ヒロ',
    channel: '登録者数 約145万人',
    publishedAt: '2024-04-04',
    videoTitle: '【名品コスメ選手権】小田切ヒロ・水越みさと・サラが選ぶ「人生最後の一品」はどれ！？人気10ブランドの中から本気で推す名品だけを厳選したわよ〜🤍',
    products: [
      {
        rank: 1,
        name: 'ADDICTION ザ ブラッシュ マット 005 Sand Castle',
        price: '¥3,300',
        comment: '「10回以上リピートしている」と小田切ヒロさんが断言するシェーディングの名品。赤みや黄みに寄りすぎない絶妙なニュアンスで、どんな肌色にも馴染み、自然な骨格を彫り起こしてくれます。',
        amazonKeyword: 'ADDICTION ザ ブラッシュ マット 005',
        rakutenKeyword: 'アディクション ザ ブラッシュ マット 005 Sand Castle',
      },
      {
        rank: 2,
        name: 'クレ・ド・ポー ボーテ ヴォワールルミヌ',
        price: '¥7,150',
        comment: '水越みさとさんが「今何も持っていなくて1つしか買えないならこれ」と選んだ美白下地。4MSK美容液成分配合で、メイクしながらスキンケア効果も高く、肌を疲れさせない名品です。',
        amazonKeyword: 'クレドポーボーテ ヴォワールルミヌ',
        rakutenKeyword: 'クレ・ド・ポー ボーテ ヴォワールルミヌ 医薬部外品',
      },
      {
        rank: 3,
        name: 'Dior ディオールスキン フォーエヴァー ベルベット ヴェール',
        price: '¥7,150',
        comment: '「5本はリピートした」と小田切ヒロさんが語るマット下地。乾燥肌でも使えるマット感で、肌の気になる部分をミュートし、ラグジュアリーで上質な肌にランクアップさせてくれます。',
        amazonKeyword: 'Dior ディオールスキン フォーエヴァー ベルベット ヴェール',
        rakutenKeyword: 'ディオール フォーエヴァー ベルベット ヴェール',
      },
      {
        rank: 4,
        name: 'セザンヌ セラムクッションファンデーション',
        price: '¥1,078',
        comment: '「デパコスに並んでいても遜色ない」とサラさんが驚愕したプチプラの傑作。この価格でカバー力・密着力・ツヤ感のバランスが完璧で、妥協ではなくこれを選びたくなるクオリティです。',
        amazonKeyword: 'セザンヌ セラムクッションファンデーション',
        rakutenKeyword: 'セザンヌ セラムクッションファンデーション',
      },
      {
        rank: 5,
        name: 'コスメデコルテ フェイスパウダー 00 Translucent',
        price: '¥6,050',
        comment: '水越みさとさんのおすすめ。ノンパールなのに圧倒的なツヤが出て、しっとり感が持続します。「使っても使ってもなくならない、実質無料」と言わせるほどコスパも良い定番の名品です。',
        amazonKeyword: 'コスメデコルテ フェイスパウダー 00 Translucent',
        rakutenKeyword: 'コスメデコルテ フェイスパウダー 00',
      },
    ],
  }
];
